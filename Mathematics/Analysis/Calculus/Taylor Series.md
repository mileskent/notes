...
An infinite [[Series]] representing a [[Mathematics/Set Theory/Function|Function]], expressed in terms of the function's derivatives at a single point. It allows complex functions to be approximated by [[Polynomial]]s.
