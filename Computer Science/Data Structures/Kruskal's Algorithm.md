...
* Computing [[Minimum Spanning Tree]] for [[Directed|Undirected]], [[Connected]] [[Computer Science/Data Structures/Graph]]
 ...
 * Main Idea
	 ...
	 * We check if we can add each edge so long as it doesnt make a [[Cycle]]
		 ...
		 * The Visited Set idea from other [[Computer Science/Data Structures/Graph]] [[Traversal Algorithm]] fails, which is why use [[Disjoint Set]]s
