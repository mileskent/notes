...
date: 2025-01-07
---
*A* [[Shortest Path Algorithm]] designed to solve the single source shortest path problem in a [[Computer Science/Data Structures/Graph]]. 
...
> * [[Binary Heap]] method
> 	* $O((|V| + |E|) \log |V|)$
> 	* Connected [[Computer Science/Data Structures/Graph]] -> $O(|E| \log |V|)$
