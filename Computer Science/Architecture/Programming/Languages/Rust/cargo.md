...
*Cargo* is the official [[Rust]] [[Package Manager]] and build system that orchestrates fetching dependencies, [[Computer Science/Architecture/Compilers/Compiler|compiling]] code, and distributing libraries.
