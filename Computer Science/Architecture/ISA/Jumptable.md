...
date: 2025-01-07
---
How a switch statement can be faster than "equivalent" if else chaining, but it of course depends upon the implementation of the [[Computer Science/Architecture/Compilers/Compiler]].
