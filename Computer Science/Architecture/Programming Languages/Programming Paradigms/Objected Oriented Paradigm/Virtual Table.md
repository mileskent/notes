...
aliases:
  ...
  - Virtual Table
---
In statically-typed, [[Object Oriented Programming Language|Object Oriented Language]]s (e.g. [[C++]], [[Java]]), a vtable is a lookup table
* Created by the [[Computer Science/Architecture/Compilers/Compiler]] to support [[Dynamic Dispatch]].
