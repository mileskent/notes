...
* Computing [[Minimum Spanning Tree]] for [[Directed|Undirected]], [[Connected]] [[Computer Science/Algorithms/Graph]]
 ...
 * Main Idea
	 ...
	 * We check if we can add each edge so long as it doesnt make a [[Cycle]]
		 ...
		 * The Visited Set idea from other [[Computer Science/Algorithms/Graph]] [[Traversal Algorithm]] fails, which is why use [[Disjoint Set]]s
