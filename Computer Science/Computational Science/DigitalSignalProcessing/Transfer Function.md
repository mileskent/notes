...
where $B$ and $A$ are polynomials with coefficients determined by the system's [[Linear Constant Coefficient Difference Equation|LCCDE]]. It completely characterizes the system's input-output relationship in the z-domain. The [[Pole|poles]] of $H(z)$ determine the system's fundamental modes.
