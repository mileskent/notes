...
Systems expressible as [[Linear Constant Coefficient Difference Equation|difference equations]] can be written as polynomials in $\mathcal{R}$ and manipulated algebraically. The difference machine $y[n] = x[n] - x[n-1]$ becomes:
