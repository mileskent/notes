...
---
*Lagrange polynomial interpolation* estimates the value of a [[Discrete-Time Signal]] in-between its integer [[Sampling|sample]] positions by constructing a [[Polynomial]] [[Mathematics/Set Theory/Function|Function]] that "connects the dots". 
