...
> [!tip]+ Derivation from [[Computer Science/Computational Science/Digital Signal Processing/Fourier Series]]
> Let $F(m) \equiv \mathbb{E}_m - i\ \mathbb{O}_{m}$ 
> where these values are defined in [[Even Function]] and [[Odd Function]] and also [[Computer Science/Computational Science/Digital Signal Processing/Fourier Series]]
> $$
> \begin{align} \\
> F(m) \equiv
